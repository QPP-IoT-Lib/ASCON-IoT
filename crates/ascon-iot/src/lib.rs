//! Ascon-AEAD128 baseline implementation for IoT use cases.
//!
//! This crate intentionally keeps the authenticated encryption
//! algorithm separated from any particular random-number generator.
//!
//! Callers are responsible for supplying random material such as keys
//! (for example from [QPP-RNG](https://github.com/QPP-IoT-Lib/QPP-RNG-IoT),
//! or any other source implementing `rand_core::Rng`). Ascon-AEAD128
//! itself remains the standard NIST SP 800-232 construction.
//!
...
/// `rand_core::Rng`.
///
/// Any RNG implementing this interface can be used, including
/// QPP-RNG's `QppRngSource`.
#[inline]
