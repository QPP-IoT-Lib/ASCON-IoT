use ascon_iot::{BaselineAsconAead128, generate_key, generate_random_nonce};
...
fn qpp_rng_supplies_ascon_key_and_nonce() {
    ...
    // Reference QPP-RNG implementation, pulled in from the QPP-RNG-IoT
    // repository as a dev-dependency (see the workspace Cargo.toml).
